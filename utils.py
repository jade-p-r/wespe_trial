...
def process_command_args(arguments):
    ...
    # NEw vaues from https://github.com/JuheonYi/WESPE-TensorFlow
    w_content = 0.1
    w_color = 25
    w_texture = 3
    w_tv = 1/400
    ...
    if phone == "":
        ...
        print("python train_model.py model={iphone,blackberry,sony,food}\n")
        sys.exit()

    if phone not in ["iphone", "sony", "blackberry","food"]:
...
def process_test_model_args(arguments):
    ...
    if phone == "":
        ...
        print("python test_model.py model={iphone,blackberry,sony,food,iphone_orig,blackberry_orig,sony_orig,food_orig}\n")
        sys.exit()
